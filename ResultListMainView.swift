...
//                                        .fontWeight(Font.Weight?)
            ...
            HStack{
                ...
                Button(action: {
                    ...
                    if let caption_id = self.note.id{
                        print("caption_id", caption_id);
                        print("user_id", globalUserId);
                        print("liked", liked);
                        
                        
                        var str = "caption_id=" + String( caption_id );
                        str += "&liked=" + (liked ? "1" : "0")  ;
                        
                        print(str);
                        
                        network.setCaptions(params: str);
                    ...
                    //
                    ((self.liked || (self.note.liked == 1)) ? Image("heart-red") : Image("small-heart")).resizable().frame(width: 25, height: 25, alignment: .trailing)
                }
                Button(action: {
                    print("icon")
                    ...
                    //
                    (copied ? Image("copy-blue") : Image("small-copy")).resizable().frame(width: 25, height: 25, alignment: .trailing)
                }
            }
            
        }
        .frame(minWidth: 0, maxWidth: UIScreen.screenWidth - 40)
            .font(.system(size: 11))
            .padding()
        ...
        .toast(isPresenting: $showAlert){
            ...
            AlertToast(displayMode: .alert, type: .regular, title: "Copied to clipboard")
...
struct ResultListMainView: View {
